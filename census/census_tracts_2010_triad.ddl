...
ALTER SEQUENCE census_tracts_2010_ogc_fid_seq OWNED BY census_tracts_2010.ogc_fid;
...
ALTER TABLE ONLY census_tracts_2010 ALTER COLUMN ogc_fid SET DEFAULT nextval('census_tracts_2010_ogc_fid_seq'::regclass);
...
ALTER TABLE ONLY census_tracts_2010
...
CREATE INDEX census_tracts_2010_wkb_geometry_geom_idx ON census_tracts_2010 USING gist (wkb_geometry);
